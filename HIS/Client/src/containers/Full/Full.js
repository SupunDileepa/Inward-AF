...
import ExternalTransferForms from "../../components/ExternalTransfer/ExternalTransfer";
import InternalTransferForms from "../../components/InternalTransfer/InternalTransfer";
            ...
            <Container fluid>
              <Switch>
                ...
                <Route path="/sample" name="Sample" component={Sample} />
                  <Route
                      path="/externalTransfer" name="ExternalTransfer" component={ExternalTransferForms}
                  />
                  <Route
                      path="/internalTransfer" name="InternalTransfer" component={InternalTransferForms}
                  />
